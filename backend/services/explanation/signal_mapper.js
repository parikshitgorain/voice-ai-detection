...
const getFeatures = (features) => {
  return {
    ...
    microProsodyVariability: safeNumber(features?.prosodyPlanning?.microProsodyVariability),
    ...
    phaseEntropyStability: safeNumber(features?.spectralConsistency?.phaseEntropyStability),
    ...
    breathCouplingStability: safeNumber(features?.advanced?.breathCouplingStability),
    ...
    deepScore: safeNumber(features?.deepScore),
    multiSpeakerScore: safeNumber(features?.multiSpeaker?.score),
    multiSpeakerDetected: features?.multiSpeaker?.detected === true,
...
const mapSignals = (features) => {
  ...
  const signals = [
    ...
    {
      id: "micro_prosody_stable",
      aligns: "AI_GENERATED",
      strength: scoreLow(microProsodyVariability, 0.25, 0.45),
      phrase: buildPhrase("micro-prosody variability was low", microProsodyVariability),
      value: microProsodyVariability,
    },
    {
      id: "micro_prosody_variable",
      aligns: "HUMAN",
      strength: scoreHigh(microProsodyVariability, 0.35, 0.6),
      phrase: buildPhrase("micro-prosody variability was high", microProsodyVariability),
      value: microProsodyVariability,
    },
    {
      id: "hf_decay_regular",
    ...
    {
      id: "phase_entropy_stable",
      aligns: "AI_GENERATED",
      strength: scoreHigh(phaseEntropyStability, 0.6, 0.8),
      phrase: buildPhrase("phase entropy stability was high", phaseEntropyStability),
      value: phaseEntropyStability,
    },
    {
      id: "phase_entropy_variable",
      aligns: "HUMAN",
      strength: scoreLow(phaseEntropyStability, 0.35, 0.55),
      phrase: buildPhrase("phase entropy stability was low", phaseEntropyStability),
      value: phaseEntropyStability,
    },
    {
    ...
    {
      id: "breath_coupling_stable",
      aligns: "AI_GENERATED",
      strength: scoreHigh(breathCouplingStability, 0.6, 0.8),
      phrase: buildPhrase("breath coupling stability was high", breathCouplingStability),
      value: breathCouplingStability,
    },
    {
    ...
    },
    {
      id: "deep_model_high",
      aligns: "AI_GENERATED",
      strength: scoreHigh(deepScore, 0.7, 0.85),
      phrase: buildPhrase("deep model AI probability was high", deepScore),
      value: deepScore,
    },
    {
      id: "deep_model_low",
      aligns: "HUMAN",
      strength: scoreLow(deepScore, 0.3, 0.45),
      phrase: buildPhrase("deep model AI probability was low", deepScore),
      value: deepScore,
    },
    {
      id: "multi_speaker",
      aligns: "AMBIGUOUS",
      strength: multiSpeakerDetected ? 1 : scoreHigh(multiSpeakerScore, 0.45, 0.7),
      phrase: buildPhrase("multi-speaker evidence score was elevated", multiSpeakerScore),
      value: Number.isFinite(multiSpeakerScore) ? multiSpeakerScore : null,
    },
    {
      id: "phase_irregular",
      aligns: "HUMAN",
